...
{
    public class UsersValidator:AbstractValidator<UserViewsModels>
    {
        public  UsersValidator(IUserService userService, SharedViewLocalizer<UsersValidatorResource> localizer){
